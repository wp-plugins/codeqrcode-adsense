...
**3. step** : Download CodeQRCode wordpress plugin and paste your codeqrcode Application ID
...
Paste your CodeQRCode Application ID from previous step.
...
[Click here for customer support >>](http://www.codeqrcode.com/contact/)
...
Is Application ID correct? When you save changes, does the list of your dynamic QR codes appear in dropdown? If you see only static QR code option, please login to codeqrcode.com and create first dynamic QR code.
